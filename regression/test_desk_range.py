"""Crypto-desk range forecaster (desk/, package 11.2): runs the desk's own offline suites here so the
...
MODULES = ("test_jbm_measure", "test_jbm_archive", "test_range_model", "test_range_job")
