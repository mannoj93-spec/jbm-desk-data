...
Generated 2026-09-26T12:48Z (input cutoff 2026-09-26T12:35Z). All times are UTC. lab-2.2-2026-09-24; code 7a59e3575684; commit f41f20d515d3f32a1b6fee85f2a3f09ddb0ca940; cost model costs-1 (assumed fees). Refreshed by the Research lab workflow every 6 hours; anything older is stale.

## At a glance

| Signal | State |
|---|---|
| Workflow | this report was written by the research-lab run at 2026-09-26T12:48Z; whether that run and the collector succeeded is on the repository's Actions tab |
| Data freshness | input cutoff 2026-09-26T12:35Z (13 min before this report); collection health and data age per dataset: [latest.md](latest.md) |
...
- controls selected/mature/scorable/retained/baseline-usable (* primary): 30m eval 19/18/18/18/18, reanalysis 46/46/46/46/46; 60m* eval 19/18/18/11/18, reanalysis 46/46/46/28/46; 240m eval 19/15/15/4/15, reanalysis 46/46/46/11/46; 480m eval 19/11/11/2/11, reanalysis 46/46/46/6/46
...
- prospective data: 3.7 days of stored 1-minute bars; the event threshold needs 7 days of prior windows
...
- comparison coverage (hourly-first-available-2): 2026-09-23T20:00Z to 2026-09-26T12:48Z; 64 closed hours + 1 partial; 65 hours with eligible candidates; 65 selected (59 frozen earlier); 0 closed hours without a control; availability 17.3 min after the hour (median, range 0.1-48.1)
...
- controls used: sha256 836ec788bc971b86; equal to the stored selections: True
- labelled controls = stored selections: 65 checked, 0 mismatches
- controls selected/mature/scorable/retained/baseline-usable (* primary): 30m eval 19/18/18/18/18, reanalysis 46/46/46/45/46; 60m eval 19/18/18/11/18, reanalysis 46/46/46/28/46; 240m* eval 19/15/15/4/15, reanalysis 46/46/46/11/46; 480m eval 19/11/11/2/11, reanalysis 46/46/46/6/46
- prospective/reanalysis: test firings 0, episodes 0, scorable 0, retained 0 in 0 blocks; reference retained 0; test mean — vs reference —; 90% —.
- prospective/evaluation: test firings 0, episodes 0, scorable 0, retained 0 in 0 blocks; reference retained 0; test mean — vs reference —; 90% —.
- frozen decisions: {'frozen_used': 0, 'revised_since_frozen': 0, 'not_reproduced': 0, 'late_replay': 0, 'new': 0}
- prospective data: 248 snapshot transitions for the fixed cohort; the design needs 1344 (about two weeks at 15-minute cadence)
...
- checkpoint 1 pending: 0/100 retained test observations known
- horizons: primary 240 min (decides status and proposals); secondary 30, 60, 480 min (descriptive only)
- comparison coverage (hourly-first-available-2): 2026-09-23T20:00Z to 2026-09-26T12:48Z; 64 closed hours + 1 partial; 65 hours with eligible candidates; 65 selected (59 frozen earlier); 0 closed hours without a control; availability 17.3 min after the hour (median, range 0.1-30.5)
- selections: 6 accepted this run, 0 proposals superseded by stored winners, 0 hours pending processing (decision after the cutoff), 0 stored records withheld at this cutoff
- controls used: sha256 6ee2659f3bf66bf4; equal to the stored selections: True
- labelled controls = stored selections: 65 checked, 0 mismatches
- controls selected/mature/scorable/retained/baseline-usable (* primary): 30m eval 19/18/18/18/18, reanalysis 46/46/46/46/46; 60m eval 19/18/18/11/18, reanalysis 46/46/46/28/46; 240m* eval 19/15/15/4/15, reanalysis 46/46/46/11/46; 480m eval 19/11/11/2/11, reanalysis 46/46/46/6/46
...
- prospective/evaluation: test firings 1, episodes 0, scorable 0, retained 0 in 0 blocks; reference retained 4; test mean — vs reference -12.0 bp; 90% —.
- frozen decisions: {'frozen_used': 1, 'revised_since_frozen': 0, 'not_reproduced': 0, 'late_replay': 0, 'new': 0}
- prospective data: 250 sampled snapshots; the design needs 1344
...
- horizons: primary 240 min (decides status and proposals); secondary 30, 60, 480 min (descriptive only)
- comparison coverage: hourly controls at each whole-hour bar close whose bar is stored (bar-based; not affected by the collection-time policy)
- controls selected/mature/scorable/retained/baseline-usable (* primary): 30m eval 19/18/18/18/18, reanalysis 70/70/70/46/70; 60m eval 19/18/18/11/18, reanalysis 70/70/70/28/70; 240m* eval 19/15/15/4/15, reanalysis 70/70/70/11/70; 480m eval 19/11/11/2/11, reanalysis 70/70/70/6/70
...
- frozen decisions: {'frozen_used': 0, 'revised_since_frozen': 0, 'not_reproduced': 0, 'late_replay': 0, 'new': 0}
- prospective data: 2092 twapHistory checks, 265 programs observed (2 BTC), 0 qualifying; the design needs 30 active BTC programs
...
- comparison coverage (hourly-first-available-2): 2026-09-23T00:00Z to 2026-09-26T12:48Z; 84 closed hours + 1 partial; 85 hours with eligible candidates; 85 selected (79 frozen earlier); 0 closed hours without a control; availability 17.1 min after the hour (median, range 11.7-28.0)
- selections: 6 accepted this run, 0 proposals superseded by stored winners, 0 hours pending processing (decision after the cutoff), 0 stored records withheld at this cutoff
- controls used: sha256 89287842457a0289; equal to the stored selections: True
- labelled controls = stored selections: 85 checked, 0 mismatches
- controls selected/mature/scorable/retained/baseline-usable (* primary): 30m eval 19/18/18/18/18, reanalysis 66/66/66/66/45; 60m eval 19/18/18/11/18, reanalysis 66/66/66/42/45; 240m eval 19/15/15/4/15, reanalysis 66/66/66/15/45; 480m* eval 19/11/11/2/11, reanalysis 66/66/66/8/45
...
- frozen decisions: {'frozen_used': 0, 'revised_since_frozen': 0, 'not_reproduced': 0, 'late_replay': 0, 'new': 0}
- prospective data: 287 option records (0 with a trailing z-score); the design needs 1344
...
- prospective/evaluation: test firings 0, episodes 0, scorable 0, retained 0 in 0 blocks; reference retained 11; test mean — vs reference -12.0 bp; 90% —.
- frozen decisions: {'frozen_used': 0, 'revised_since_frozen': 0, 'not_reproduced': 0, 'late_replay': 0, 'new': 0}
- prospective data: 3.7 days of stored bars; the design needs 14
...
- prospective/evaluation: test firings 0, episodes 0, scorable 0, retained 0 in 0 blocks; reference retained 0; test mean — vs reference —; 90% —.
- frozen decisions: {'frozen_used': 0, 'revised_since_frozen': 0, 'not_reproduced': 0, 'late_replay': 0, 'new': 0}
- prospective data: 4.3 days of collected OKX liquidation history; the p99 threshold needs 7
